    ...
    <section id="home" className="flex flex-col items-center justify-center min-h-[60vh] pt-24 pb-10 text-center">
      ...
      <div className="flex flex-col w-full items-center">
        ...
        <div className="w-full max-w-4xl flex flex-col items-center mb-8">
          ...
          <div className="w-full flex flex-row items-center justify-center mt-0 flex-col">
            ...
            <div className="flex flex-row items-center justify-center gap-6 mt-4 mb-2">
              <a href="#" className="shine-hover w-10 h-10 flex items-center justify-center rounded-full border-2 border-white">
              ...
              <a href="https://github.com/Trex099" target="_blank" rel="noopener noreferrer" className="shine-hover w-10 h-10 flex items-center justify-center rounded-full border-2 border-white">
            ...
            <a
              ...
              className="shine-hover mt-2 px-7 py-2 border border-white text-white rounded-full flex items-center gap-2 text-lg font-semibold hover:bg-white/10 transition shadow-lg whitespace-nowrap align-middle"
